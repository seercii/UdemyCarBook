...
namespace UdemyCarBook.Application.Validators.ReviewValidators
{
	public class CreateReviewValidator:AbstractValidator<CreateReviewCommand>
	{
		public CreateReviewValidator()
		{
			...
			RuleFor(x => x.Comment).MinimumLength(20).WithMessage("Lütfen yorum kısmına en az 20 karakter giriniz.");
			RuleFor(x => x.Comment).MaximumLength(500).WithMessage("Lütfen yorum kısmına en fazla 500 karakter giriniz.");
		}
	}
}
